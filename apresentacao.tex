...
\include{secoes/00_APRESENTACAO}

\section{Introdução}
\include{secoes/00_INTRO}

\section{Tipagem Dinâmica, mas nem tanto}
\include{secoes/01_tipagem}

\section{Tipos, Instruções e Estilo}
\include{secoes/02_tipos_instrucoes_estilo}

\section{Funções e Classes}
\include{secoes/03_classes}

\section{Prática}
\include{secoes/04_PRATICAS}

%Finalizando
\include{secoes/05_FINAL}
